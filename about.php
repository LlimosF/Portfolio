<div id="about">
  ...
  <div class="container-about">
    ...
    <div class="container-about-bloc-number">
      ...
      <img src="media/about/selfi.png" alt="Icone développeur web" class="container-about-logo">
    ...
    <div class="container-about-bloc" tabindex="0">
      ...
      <img src="media/about/diplome.png" alt="Icone de diplôme" class="container-about-logo">
    ...
    <div class="container-about-bloc" tabindex="0">
      ...
      <img src="media/about/passion.png" alt="Icone de passion" class="container-about-logo">
    ...
    <div class="container-about-bloc-number">
      ...
      <img src="media/about/passion.png" alt="Icone d'expérience" class="container-about-logo">
    ...
    <div class="container-about-bloc-number">
      ...
      <img src="media/about/idee.png" alt="Icone d'avenir" class="container-about-logo">
